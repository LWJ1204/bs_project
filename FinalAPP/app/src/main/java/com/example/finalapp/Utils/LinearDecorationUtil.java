...
public class LinearDecorationUtil extends RecyclerView.ItemDecoration {
    ...
    private final String tag="decoration_tag";
    /**
     * 默认分割线：高度为2px，颜色为灰色
     *
     * @param context
     ...
     */
    public LinearDecorationUtil(Context context, int orientation) {
        Log.i(tag,"decotation clicked");
     ...
     */
    public LinearDecorationUtil(Context context, int orientation, int drawableId) {
     ...
     */
    public LinearDecorationUtil(Context context, int orientation, int dividerHeight, int dividerColor) {

        this(context, orientation);
        Log.i(tag,"decotation diy clicked");
